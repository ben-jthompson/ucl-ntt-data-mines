...
from .data_graph.data_pipeline_graph import region_node, cooling_node, environmental_node, data_formatting_node, data_bibliography
...
def build_session_graph():
    ...
    graph.add_edge("environmental", "data_formatter")
