...
from .data_graph.data_pipeline_graph import  start_node, region_node, mining_node, cooling_node, environmental_node, data_bibliography
from .formatting_graph.formatter_pipeline_graph import data_rewriter_node, rag_rewriter_node, pdf_creation_node, metadata_making_node, zipper_node
...
def build_session_graph():
    ...
    graph.add_node("rag_rewriter", rag_rewriter_node)
    ...
    graph.add_edge("data_rewriter", "rag_rewriter")
    graph.add_edge("rag_rewriter", "builder")
